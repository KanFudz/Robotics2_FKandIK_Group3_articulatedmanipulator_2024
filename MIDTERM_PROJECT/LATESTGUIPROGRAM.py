...
def calculate_forward():
    try:
        ...
        T1_slider = Scale(J_sw,from_=0,to_=3.142,orient=HORIZONTAL,length=100,sliderlength=10, bg="white")
        T1_unit = Label(J_sw,text=("rad/s"),font=(5), bg='#010128', fg='white')

        T2_velo = Label(J_sw,text=("θ2* = "),font=(5), bg='#06063C', fg='white') 
        T2_slider = Scale(J_sw,from_=0,to_=3.142,orient=HORIZONTAL,length=100,sliderlength=10, bg="white")
        T2_unit = Label(J_sw,text=("rad/s"),font=(5), bg='#06063C', fg='white')

        T3_velo = Label(J_sw,text=("θ3* = "),font=(5), bg='#0D075F', fg='white') 
        T3_slider = Scale(J_sw,from_=0,to_=3.142,orient=HORIZONTAL,length=100,sliderlength=10, bg="white")
